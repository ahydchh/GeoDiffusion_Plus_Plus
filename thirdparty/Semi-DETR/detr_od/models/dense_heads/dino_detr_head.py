...
class DINODETRHead(AnchorFreeHead):
    ...
    def _get_bboxes_single(self,
        ...
        if self.loss_cls.use_sigmoid:
            ...
            bbox_score = cls_score[bbox_index]
        else:
        ...
        return det_bboxes, det_labels, bbox_score
    ...
    def rwd_loss_single(self,
        ...
        cls_reg_targets = self.rwd_get_targets(cls_scores_list, bbox_preds_list,
                                        gt_bboxes_list, gt_labels_list, gt_scores_list,
    ...
    def rwd_get_targets(self,
        ...
        (labels_list, label_weights_list, bbox_targets_list,
        bbox_weights_list, pos_inds_list, neg_inds_list) = multi_apply(
            self.rwd_get_target_single, cls_scores_list, bbox_preds_list,
    ...
    def rwd_get_target_single(self,
                           cls_score,
                           bbox_pred,
                           gt_bboxes,
                           gt_labels,
