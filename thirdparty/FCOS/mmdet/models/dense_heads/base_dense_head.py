...
class BaseDenseHead(BaseModule, metaclass=ABCMeta):
    ...
    def get_bboxes(self,
        ...
        for img_id in range(len(img_metas)):
            ...
            r1,r2,valid_mask = self._get_bboxes_single(cls_score_list, bbox_pred_list,
        ...
        return result_list, valid_mask_list
    ...
    def _get_bboxes_single(self,
        ...
        for level_idx, (cls_score, bbox_pred, score_factor, priors) in \
            ...
            scores, labels, keep_idxs, filtered_results, valid_mask = results
            ...
            bboxes = self.bbox_coder.decode(
                priors, bbox_pred, max_shape=img_shape) # [121600,4][304000,4][76000,4][19760,4][5600,4]
            ...
            mlvl_valid_mask.append(valid_mask)
            if with_score_factors:
                mlvl_score_factors.append(score_factor)
        # import pdb;pdb.set_trace()

        return self._bbox_post_process(mlvl_scores, mlvl_labels, mlvl_bboxes, mlvl_valid_mask,
    ...
    def _bbox_post_process(self,
        ...
        mlvl_valid_mask = torch.cat(mlvl_valid_mask)
        ...
        if with_nms:
            ...
            mlvl_bboxes = torch.cat([mlvl_bboxes,mlvl_scores[:,None]],-1)
            # print(mlvl_bboxes.size())
            # import pdb;pdb.set_trace()
            # torch.set_printoptions(threshold=sys.maxsize)
            # print(mlvl_bboxes)
            return mlvl_bboxes, mlvl_labels, mlvl_valid_mask
